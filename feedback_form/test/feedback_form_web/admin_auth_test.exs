defmodule FeedbackFormWeb.AdminAuthTest do
  use FeedbackFormWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias FeedbackForm.Accounts
  alias FeedbackFormWeb.AdminAuth
  import FeedbackForm.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FeedbackFormWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FeedbackFormWeb.Endpoint.subscribe(live_socket_id)

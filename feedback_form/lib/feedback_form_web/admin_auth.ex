defmodule FeedbackFormWeb.AdminAuth do
  use FeedbackFormWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_feedback_form_web_admin_remember_me"
  ...
  def log_out_admin(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      FeedbackFormWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_admin:
      ...
      defmodule FeedbackFormWeb.PageLive do
        use FeedbackFormWeb, :live_view

        on_mount {FeedbackFormWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{FeedbackFormWeb.AdminAuth, :ensure_authenticated}] do
